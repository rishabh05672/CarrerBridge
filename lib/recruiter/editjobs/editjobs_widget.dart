...
import 'editjobs_model.dart';
export 'editjobs_model.dart';
...
class _EditjobsWidgetState extends State<EditjobsWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<JobsRecord>(
      stream: JobsRecord.getDocument(widget!.jobID!),
      builder: (context, snapshot) {
        ...
        final editjobsJobsRecord = snapshot.data!;
                                    ...
                                    child: Container(
                                      ...
                                      child: TextFormField(
                                        controller:
                                          ...
                                          text: editjobsJobsRecord.jobTitle,
                                        ),
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.experienceTextController ??=
                                                TextEditingController(
                                          text: editjobsJobsRecord.experience,
                                        ),
                                      ...
                                      child: Container(
                                        ...
                                        child: TextFormField(
                                          ...
                                          onFieldSubmitted: (_) async {
                                            _model.skillsName = await JobsRecord
                                                .getDocumentOnce(
                                                    widget!.jobID!);
                                            _model.skill = _model
                                                .skillsName!.skills
                              ...
                              child: Row(
                                ...
                                children: [
                                  Expanded(
                                    child: Builder(
                                      builder: (context) {
                                        final skills = _model.skill.toList();
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.salaryTextController ??=
                                                TextEditingController(
                                          text: editjobsJobsRecord.salary,
                                        ),
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.locationTextController ??=
                                                TextEditingController(
                                          text: editjobsJobsRecord.location,
                                        ),
                                ...
                                children: [
                                  Expanded(
                                    child: Container(
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.jobTypeTextController ??=
                                                TextEditingController(
                                          text: editjobsJobsRecord.jobType,
                                        ),
                                        focusNode: _model.jobTypeFocusNode,
                                        autofocus: false,
                                        obscureText: false,
                                        decoration: InputDecoration(
                                          isDense: true,
                                        ...
                                        cursorColor:
                                            FlutterFlowTheme.of(context)
                                                .primaryText,
                                        validator: _model
                                            .jobTypeTextControllerValidator
                                            .asValidator(context),
                                      ),
                                    ),
                                  ),
                                    ...
                                    child: Container(
                                      ...
                                      child: TextFormField(
                                        controller: _model
                                            ...
                                            TextEditingController(
                                          text:
                                              editjobsJobsRecord.jobdescription,
                                        ),
                                        focusNode:
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.companyNameTextController ??=
                                                TextEditingController(
                                          text: editjobsJobsRecord.companyname,
                                        ),
                                ...
                                children: [
                                  Expanded(
                                    child: Container(
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.companyURLTextController ??=
                                                TextEditingController(
                                          text: editjobsJobsRecord.companyurl,
                                        ),
                                        focusNode: _model.companyURLFocusNode,
                                        autofocus: false,
                                        obscureText: false,
                                        decoration: InputDecoration(
                                          isDense: true,
                                          labelText: 'CompanyWebsite',
                                          labelStyle:
                                              FlutterFlowTheme.of(context)
                                                  .labelMedium
                                                  .override(
                                        ...
                                        cursorColor:
                                            FlutterFlowTheme.of(context)
                                                .primaryText,
                                        validator: _model
                                            .companyURLTextControllerValidator
                                            .asValidator(context),
                                      ),
                                    ),
                                  ),
                                    ...
                                    onPressed: () async {
                                      if ((_model.roleTextController.text != null &&
                                              _model.roleTextController.text !=
                                                  '') &&
                                          (_model.experienceTextController.text != null &&
                                              _model.experienceTextController.text !=
                                                  '') &&
                                          (_model.salaryTextController.text != null &&
                                              _model.salaryTextController.text !=
                                                  '') &&
                                          (_model.locationTextController.text != null &&
                                              _model.locationTextController.text !=
                                                  '') &&
                                          (_model.skill.length > 0) &&
                                          (_model.jobTypeTextController.text != null &&
                                              _model.jobTypeTextController.text !=
                                                  '') &&
                                          (_model.jobDescriptionTextController.text != null &&
                                              _model.jobDescriptionTextController.text !=
                                                  '') &&
                                          (_model.companyNameTextController.text != null &&
                                              _model.companyNameTextController.text !=
                                                  '') &&
                                          (_model.companyURLTextController.text != null &&
                                              _model.companyURLTextController.text !=
                                                  '') &&
                                          ((_model.uploadedFileUrl != null &&
                                                  _model.uploadedFileUrl !=
                                                      '') ||
                                              (editjobsJobsRecord.companylogo !=
                                                      null &&
                                                  editjobsJobsRecord.companylogo !=
                                                      ''))) {
