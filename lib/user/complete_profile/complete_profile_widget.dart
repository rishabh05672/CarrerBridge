...
class _CompleteProfileWidgetState extends State<CompleteProfileWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.skills =
          (currentUserDocument?.skills?.toList() ?? []).toList().cast<String>();
      safeSetState(() {});
    });
    ...
    _model.experienceTextController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.experience, ''));
                        ...
                        InkWell(
                          ...
                          child: Builder(
                            builder: (context) {
                              if (currentUserPhoto != null &&
                              ...
                              } else if (_model.uploadedFileUrl1 != null &&
                                ...
                                return Container(
                                  ...
                                  child: Image.asset(
                                    'assets/images/dummy-man-570x570-1.png',
                                    fit: BoxFit.cover,
                                  ),
                                );
                              }
                                    ...
                                    child: Builder(
                                      builder: (context) {
                                        ...
                                        return Wrap(
                                          ...
                                          children:
                                              List.generate(skillsadd.length,
                                                  (skillsaddIndex) {
                                            final skillsaddItem =
                                                skillsadd[skillsaddIndex];
                                            return Padding(
                                      ...
                                      await currentUserReference!.update({
                                        ...createUserRecordData(
                                          ...
                                          photoUrl: _model.uploadedFileUrl1 !=
                                              ...
                                              ? _model.uploadedFileUrl1
                                              : currentUserPhoto,
                                          resumeURL: _model.uploadedFileUrl2 !=
                                                      null &&
                                                  _model.uploadedFileUrl2 != ''
                                              ? _model.uploadedFileUrl2
                                              : valueOrDefault(
